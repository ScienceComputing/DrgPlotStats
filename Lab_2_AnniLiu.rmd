...
[A link to the repository](https://github.com/anniliu1/DrgPlotStat.git)
...
## install('DrgPlotStat') ## install new package
...
## install_github('anniliu1/DrgPlotStat') ## install package from GitHub
```
